...
<div class="header" >
    <div id="logo_image1"><img src=../images/odhea.jpg /></div>
                <div >
						...
						<div style="font-size:20px;"><strong>Odhea</strong></div>
						<div style="font-size:14px;">Jl. MT. Haryono (depan Bank PANIN) SINTANG</div>
						<div style="font-size:13px;">Telp : 0813 2691 2356 Email : 28harin@gmail.com</div>
						</div><br><br>
	</div>
	</head>
	<?php
...
while($rows=mysql_fetch_object($result)){
		...
		<div style=font-size:16px;font-family:arial;color:#333;>Penanggung Jawab : dr. Harina Salim, M.Sc., SpPK</div>
		</div>
		...
		<div style=text-align:left;font-family:arial;color:#333;>harap segera menghubungi Laboratorium Klinik odhea</div>
		</div>
			<br>
